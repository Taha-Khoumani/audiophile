      ...
      <div className="category-product-text">
        {isNew && (
          <p
            className={
              props.isCat
                ? "category-product-text-new"
                : "category-product-text-new-2"
            }
          >
            {" "}
            NEW PRODUCT
        ...
        <p
          className={
            props.isCat
              ? "category-product-text-name"
              : "category-product-text-name-2"
          }
        >
          {name}
        </p>
        <p
          className={
            props.isCat
              ? "category-product-text-description"
              : "category-product-text-description-2"
          }
        >
          {description}
        </p>
        {props.isCat ? (
          ...
          <>
            ...
            <div className="product-nums">
              ...
              <p>{currentQuantity}</p>
              <button onClick={() => setCurrentQuantity((prevQ) => prevQ + 1)}>
                +
              </button>
            </div>
            <button
              className="button"
              onClick={() => {
                props.functions.handleClickAdd(
                  slug,
                  shortName,
                  price,
                  currentQuantity
